...
public class UserController {
    ...
    public String transfer(QueryVo vo, HttpServletRequest request) {

        int id = vo.getId();
        BigDecimal money = vo.getMoney();
        String getMoneyUser = vo.getGetMoneyUser();
    ...
    public String updatePwd(String newPwd, String id, HttpServletRequest request) {
