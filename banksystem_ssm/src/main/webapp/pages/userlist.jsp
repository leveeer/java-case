...
<div class="container">
    ...
    <div style="float: right">
        <form class="form-inline" action="${pageContext.request.contextPath}/admin/findUserByCondition.do"
              method="post">
            <div class="form-group">
                <label for="exampleInputName2">用户id:</label>
                <input type="text" name="id" value="${queryVo.id}" class="form-control" id="exampleInputName2">
            </div>
            <div class="form-group">
                <label for="exampleInputName3">用户名:</label>
                <input type="text" name="username" value="${queryVo.username}" class="form-control"
    ...
    <div style="float: left;margin: 5px">
<%--
        <button onclick="add()" class="btn btn-primary">导入Excel</button>
--%>
        <input type="file" id="file" name="file" class="btn-primary">
    </div>

    <div style="float: left;margin: 5px">
        <a class="btn btn-primary" href="${pageContext.request.contextPath}/excel/excel_down.do">导出Excel</a>
    </div>
            ...
            <c:forEach items="${pageBean.list}" var="user" varStatus="s">
                <tr bgcolor="#faebd7">
                    ...
                    <td>
                        ...
                        <a class="btn btn-default btn-sm" href="${pageContext.request.contextPath}/admin/userRecord.do?id=${user.id}">用户操作明细</a>&nbsp;&nbsp;&nbsp;&nbsp;
...
<div>
    ...
    <div style="width: 380px; float: left;margin-left: 200px; margin-top: 10px">
        <ul class="pagination" style="text-align: center; margin-top: 10px;">
            ...
            <c:if test="${pageBean.currentPage != 1}">
                <li>
                    <a href="${pageContext.request.contextPath}/admin/findAllUser.do?currentPageStr=${pageBean.currentPage - 1}"
                       aria-label="Previous">
                        <span aria-hidden="true">&laquo;</span>
                    </a>
                </li>
            ...
            <c:forEach begin="1" end="${pageBean.totalPage}" var="page">
                ...
                <c:if test="${page != pageBean.currentPage}">
                    <li>
                        <a href="${pageContext.request.contextPath}/admin/findAllUser.do?currentPageStr=${page}">${page}</a>
                    </li>
                </c:if>
            </c:forEach>
            <%--下一页--%>
    ...
    <div class="button">
        <input type="button" class="btn btn-primary" value="显示全部用户"
               onclick="window.location='${pageContext.request.contextPath}/admin/findAllUser.do'">
