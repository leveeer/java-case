           ...
           //给username绑定blur事件
            $("#username").blur(function () {
               ...
               if (username == ""){
                   ...
                   s_username.html("用户名格式错误");

               }else{
                   //发送ajax请求
                   $.post("${pageContext.request.contextPath}/userServlet/findUserByUsername",{username:username},function (data) {
...
<div class="rg_layout">
    ...
    <div class="rg_center">
        <div class="rg_form">
            <!--定义表单 form-->
            <form action="${pageContext.request.contextPath}/userServlet/register" id="form" method="post">
                <table>
                    <tr>
