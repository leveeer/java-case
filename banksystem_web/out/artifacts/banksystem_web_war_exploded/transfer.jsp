...
<div class="container" style="width: 400px;margin-top: 100px">
    ...
    <form action="${pageContext.request.contextPath}/userServlet/transfer?id=${user.id}" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="transferMoney" name="transferMoney" placeholder="请输入转账金额" />
        </div>
