...
<ul class="nav nav-pills" style="text-align: center">
    ...
    <li role="presentation" class="active"><a href="${pageContext.request.contextPath}/userServlet/inquiry?username=${user.username}">查询余额</a></li>
    ...
    <li role="presentation" class="active"><a href="${pageContext.request.contextPath}/userServlet/record?id=${user.id}">查询明细</a></li>
    <li role="presentation" class="active"><a href="#">修改密码</a></li>
    <li role="presentation" class="active"><a href="${pageContext.request.contextPath}/userServlet/exit">退&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;卡</a></li>
</ul>
