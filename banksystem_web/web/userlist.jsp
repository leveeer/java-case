        ...
        function unLocked(id,isLocked) {
            if (isLocked == 0){
                ...
                if(confirm("您确定为该用户解冻吗?")){
                    //确定,执行删除操作
                    isLocked = 0;
                    location.href="${pageContext.request.contextPath}/adminServlet/changeLocked?id=" + id + "&isLocked=" + isLocked;
                }
            }
        }
...
<div class="container">
    ...
    <div style="float: right">
        <form class="form-inline" action="${pageContext.request.contextPath}/adminServlet/findUser" method="post">
            <div class="form-group">
                <label for="exampleInputName2">用户id:</label>
                <input type="text" name="id" value="${condiction.id[0]}" class="form-control" id="exampleInputName2" >
            </div>
            <div class="form-group" >
                <label for="exampleInputName3">用户名:</label>
                <input type="text" name="username" value="${condiction.username[0]}" class="form-control" id="exampleInputName3" >
            </div>
            <%--<div class="form-group">
...
<div class="button">
    <input type="button" class="btn btn-primary" value="显示全部用户" onclick="window.location='${pageContext.request.contextPath}/adminServlet/findUser'">
