        ...
        try{
            ...
            for(Element mapperElement : mapperElements){
                ...
                if(attribute != null){
                    ...
                    //取出属性的值
                    String mapperPath = attribute.getValue();//获取属性的值"com/jxau/dao/UserDao.xml"
                    System.out.println(mapperPath);     //com/jxau/dao/UserDao.xml
        ...
        for(Method method : methods){
            ...
            if(isAnnotated){
                ...
                if(type instanceof ParameterizedType){
                    ...
                    mapper.setResultType(substring);
                }
                //组装key的信息
                //获取方法的名称
