        ...
        <td style='padding-left:3px;padding-top:8px' valign="top">
            ...
            <dl class='bitem'>
                ...
                <dd style='display:block' class='sitem' id='items2_1'>
                    <ul class='sitemu'>
                        <li><a href="<%=path %>/student.do?command=scoreInquiry&id=${student.id}" target='main'>学生成绩查询</a>
                        </li>
                    </ul>
                </dd>
            </dl>
            <dl class='bitem'>
                ...
                <dd style='display:block' class='sitem' id='items3_1'>
                    <ul class='sitemu'>
                        <li><a href='<%=path %>/student.do?command=announceInquiry' target='main'>通告信息查看</a></li>
                    </ul>
                </dd>
            </dl>
            <dl class='bitem'>
            ...
            <dl class='bitem'>
                ...
                <dd style='display:block' class='sitem' id='items99_1'>
                    <ul class='sitemu'>
                        <li><a href='<%=path %>' onclick='javascript:window.parent.location="<%=path %>/student.do?command=logout"'>退出登录</a></li>
                    </ul>
                </dd>
            </dl>
        </td>
