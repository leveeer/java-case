...
<body>
<form method="post" action="${pageContext.request.contextPath}/student.do?command=updatePassword" target="_top" id="form" >
    <table border="1">
        <tr>
            <th width="20%">原密码</th>
            <td width="60%"><input type="text" name="password" id="password" value="${student.password}" readonly ></td><span style="color: red"></span>
        </tr>
        <tr>
