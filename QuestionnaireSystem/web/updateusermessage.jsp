...
<div class="container" style="width: 400px;">
    <h3 style="text-align: center;">修改注册用户信息</h3>
    <form action="${pageContext.request.contextPath}/updateUserServlet" method="post">
        ...
        <div class="form-group" style="text-align: center">
            ...
            <input class="btn btn-default" type="button" value="返回" onclick="window.location='${pageContext.request.contextPath}/userListServlet'"/>
        </div>
    </form>
</div>
</body>
