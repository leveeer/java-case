...
<center>
    <div>
        <h1 class="title">欢迎您，<span style="color: red">${user.username}</span></h1><br>
        <h3 class="opera">请选择服务</h3>
    </div>
</center>

<center><ul class="nav nav-pills" style="text-align: center">

    <li role="presentation" class="active"><a href="${pageContext.request.contextPath}/userAction.do?command=inquiry&id=${user.id}">查询余额</a></li>
...
<center><img id="img" src="img/welcome_1.jpg" width="70%" height="450"></center>
