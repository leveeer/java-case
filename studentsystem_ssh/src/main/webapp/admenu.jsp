        ...
        <td style='padding-left:3px;padding-top:8px' valign="top">
            <dl class='bitem'>
                ...
                <dd style='display:block' class='sitem' id='items1_1'>
                    <ul class='sitemu'>
                        <li><a href='<%=path %>/admin.do?command=findStudentInfo' target='main'>学生信息管理</a></li>
            ...
            <dl class='bitem'>
                ...
                <dd style='display:block' class='sitem' id='items2_1'>
                    <ul class='sitemu'>
                        <li><a href="${pageContext.request.contextPath}/admin.do?command=studentGrade">学生成绩管理</a></li>
                        <li><a href="${pageContext.request.contextPath}/admin.do?command=findAllCourse">学生成绩录入</a></li>
                    </ul>
                </dd>
            </dl>
            <dl class='bitem'>
                <dt onClick='showHide("items3_1")'><b>课程管理</b></dt>
                <dd style='display:block' class='sitem' id='items3_1'>
                    <ul class='sitemu'>
                        <li><a href='<%=path %>/admin.do?command=findAllCourses' target='main'>课程管理</a></li>
                        <li><a href='<%=path %>/admin/courseAdd.jsp' target='main'>课程添加</a></li>
                    </ul>
                </dd>
            </dl>
            <dl class='bitem'>
                <dt onClick='showHide("items4_1")'><b>通告</b></dt>
                <dd style='display:block' class='sitem' id='items4_1'>
                    <ul class='sitemu'>
                        <li><a href="${pageContext.request.contextPath}/admin.do?command=findAllAnnounce">通告信息管理</a>
                        </li>
            ...
            <dl class='bitem'>
                <dt onClick='showHide("items5_1")'><b>管理员账号</b></dt>
                <dd style='display:block' class='sitem' id='items5_1'>
                    <ul class='sitemu'>
                        <li><a href='<%=path %>/admin.do?command=findAllAdmin' target='main'>管理员信息</a></li>
            ...
            <dl class='bitem'>
                ...
                <dd style='display:block' class='sitem' id='items99_1'>
                    <ul class='sitemu'>
                        <li><a href='#'
                               onclick='javascript:window.parent.location="<%=path %>/admin.do?command=logout"'>退出登录</a>
                        </li>
                    </ul>
                </dd>
            </dl>
