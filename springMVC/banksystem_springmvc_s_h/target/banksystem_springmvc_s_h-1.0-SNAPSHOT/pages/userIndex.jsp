...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" id="sidebar-wrapper" role="navigation">
        <ul class="nav sidebar-nav">
            ...
            <li>
                <a href="${pageContext.request.contextPath}/user/inquiry.do?id=${sessionScope.user.id}"><i class="fa fa-fw fa-folder"></i>查询余额</a>
            </li>
            <li>
            ...
            <li>
                <a href="${pageContext.request.contextPath}/user/record.do?id=${sessionScope.user.id}"><i class="fa fa-fw fa-file-o"></i>查询明细</a>
            </li>
            <li>
        ...
        <div class="Choices">
            <div class="Choices_text">
                ...
                <div class="Choices_content">
                    <div class="Choicesnext"><img src="${pageContext.request.contextPath}/img/Choicesnext.png" width="38"></div>
                    <div class="Choices_banner">
                        <ul>
                            <li>
                                <div class="Choices_left"><img src="${pageContext.request.contextPath}/img/Choices1.jpg" width="594"></div>
                            ...
                            <li>
                                <div class="Choices_left"><img src="${pageContext.request.contextPath}/img/Choices2.jpg" width="594"></div>
                                <div class="Choices_right">
                                    <h1>专业理财顾问</h1>
                                    <h2></h2>
                            ...
                            <li>
                                <div class="Choices_left"><img src="${pageContext.request.contextPath}/img/Choices3.jpg" width="594"></div>
                                <div class="Choices_right">
                                    <h1>个人大额存单</h1>
                                    <h2></h2>
