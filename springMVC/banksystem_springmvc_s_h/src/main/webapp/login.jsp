...
<head>
 ...
 <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/style_login.css" tppabs="${pageContext.request.contextPath}/css/style_login.css"/>
 <style>
  body {
   height: 100%;
   background: #426785;
...
<form name="form" action="" method="post">
  ...
  <dl class="admin_login">
       ...
       <dd>
           ...
           <input style="margin-left: 20px" type="button" value="立即注册" class="submit_btn" onclick="window.location='register.jsp'"/>
       </dd>
   <!-- 用户名或密码错误提示 -->
