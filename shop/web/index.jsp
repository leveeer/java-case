		...
		<div class="container-fluid">
				...
				<div class="col-md-10">
                    ...
                    <c:forEach items="${hotProducts}" var="hotProduct">
                        <div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
                            <a href="${pageContext.request.contextPath}/productServlet/findProductById?pid=${hotProduct.pid}">
                                <img src="${pageContext.request.contextPath}/${hotProduct.pimage}" width="130" height="130" style="display: inline-block;">
                            </a>
                            <p><a href="${pageContext.request.contextPath}/productServlet/findProductById?pid=${hotProduct.pid}" style='color:#666'>${hotProduct.pname}</a></p>
                            <p><font color="#E4393C" style="font-size:16px">${hotProduct.shop_price}</font></p>
                        </div>
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
						<a href="${pageContext.request.contextPath}/productServlet/findProductById?pid=${newProduct.pid}">
							<img src="${pageContext.request.contextPath}/${newProduct.pimage}" width="130" height="130" style="display: inline-block;">
						</a>
						<p><a href="${pageContext.request.contextPath}/productServlet/findProductById?pid=${newProduct.pid}" style='color:#666'>${newProduct.pname}</a></p>
