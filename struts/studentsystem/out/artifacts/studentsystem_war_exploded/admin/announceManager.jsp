    ...
    <script language="javascript">
        function announceDel(id)
        {
            if(confirm('您确定删除吗？'))
            {
                ...
                window.location.href="${pageContext.request.contextPath}/adminServlet/announceDel?id="+id;
            }
        }
...
<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
    ...
    <c:forEach items="${announces}" var="a">
        <tr align='center' bgcolor="#FFFFFF" height="22">
            ...
            <td bgcolor="#FFFFFF" align="center">
                <a href="<%=path %>/adminServlet/findAnnounceById?id=${a.id}">${a.head}</a>
            </td>
            <td bgcolor="#FFFFFF" align="center">
                    ${a.time}
            </td>
            <td bgcolor="#FFFFFF" align="center">
                ...
                <a href="<%=path %>/adminServlet/findAnnounce?id=${a.id}">修改</a>
            </td>
        </tr>
    </c:forEach>
</table>
