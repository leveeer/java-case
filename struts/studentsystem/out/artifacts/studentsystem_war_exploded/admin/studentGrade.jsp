...
<head>
    ...
    <script language="javascript" type="text/javascript">
        function studentGradeDel(id, class_id) {
            if (confirm('您确定删除吗？')) {
                window.location.href = "${pageContext.request.contextPath}/adminServlet/gradeDel?id=" + id + "&class_id=" + class_id;
            }
        }

        function GradeAdd() {
            var url = "${pageContext.request.contextPath}/adminServlet/findAllCourse";
    ...
    <c:forEach items="${grade}" var="grade">
        <tr align='center' bgcolor="#FFFFFF" height="22">
            ...
            <td bgcolor="#FFFFFF" align="center">
                ...
                <a href="${pageContext.request.contextPath}/adminServlet/findGradeByStuIdAndClassId?stu_id=${grade.stu_id}&class_id=${grade.class_id}">修改</a>
            </td>
        </tr>
    </c:forEach>
</table>
