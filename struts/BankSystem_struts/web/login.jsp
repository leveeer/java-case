...
<script type="text/javascript">
    ...
    function judgefunction() {
        ...
        if(num == 1){
            //用户
            document.form.action="${pageContext.request.contextPath}/userAction.do?command=login";
        }else {
            //管理员
            document.form.action="${pageContext.request.contextPath}/adminAction.do?command=login";
        }
    }
