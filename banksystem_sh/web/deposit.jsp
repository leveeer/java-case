...
<style>
    ...
    <script type="text/javascript">
        ...
        function checkMoney() {
            ...
            var deposit_error = document.getElementById("deposit_error");
            if (money == ""){
                deposit_error.innerHTML = "存款金额不能为空";
                return false;
            }
            if (money < 0){
                deposit_error.innerHTML = "存款金额不能为负数";
                return false;
            }
            if (money == 0){
                deposit_error.innerHTML = "存款金额不能为0";
                return false;
            }
            ...
            if (!flag) {
                deposit_error.innerHTML = "金额输入有误";
            } else {
                deposit_error.innerHTML = "";
            }
            return flag;
        }
...
<div class="container" style="width: 400px;margin-top: 100px">
    ...
    <form id="form" action="${pageContext.request.contextPath}/userAction.do?command=deposit&d=${user.id}" method="post">
